          ...
          <strong>
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="subtitle">
                Last updated <span className="question">November 13, 2022</span>
              </span>
            </span>
          </strong>
        </span>
        ...
        <span style={{ color: 'rgb(127, 127, 127)' }}>
          <span style={{ color: 'rgb(89, 89, 89)', fontSize: 15 }}>
            <span data-custom-class="body_text">
              This privacy notice for <span className="question">Loblolly Software, LLC</span>
            ...
            <span data-custom-class="body_text">
              ...
              <span className="statement-end-if-in-editor" />) your information when you use our
              services (<span className="block-component" />"<strong>Services</strong>"
              <span className="statement-end-if-in-editor" />
              ), such as when you:
            </span>
          </span>
          ...
          <span style={{ fontSize: 15 }}>
            <span style={{ color: 'rgb(127, 127, 127)' }}>
              <span data-custom-class="body_text">
                ...
                <span className="question">help@loblollysoftware.com</span>.
              </span>
            </span>
          </span>
        </div>
        ...
        <div style={{ lineHeight: '1.5' }}>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="body_text">
              ...
              interact with <span className="block-component" />
              <span className="question">Loblolly Software, LLC</span>
              <span className="statement-end-if-in-editor" /> and the Services, the choices you
          ...
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="body_text">
              <strong>
                ...
                types of <span className="statement-end-if-in-editor" />
                parties do we share personal information?
              </strong>{' '}
              We may share information in specific situations and with specific{' '}
              <span className="block-component" />
              categories of <span className="statement-end-if-in-editor" />
              third parties. Click&nbsp;
            </span>
          </span>
        ...
        <div style={{ lineHeight: '1.5' }}>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="body_text">
              ...
              <span className="block-component" />
              organizational
              <span className="statement-end-if-in-editor" /> and technical processes and procedures
              ...
              <span className="block-component" />
              unauthorized
              <span className="statement-end-if-in-editor" /> third parties will not be able to
        ...
        <div style={{ lineHeight: '1.5' }}>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="body_text">
              ...
              <span className="block-component" />
              here: <span className="question">help@loblollysoftware.com</span>
              <span className="else-block" />, or by contacting us. We will consider and act upon
        ...
        <div style={{ lineHeight: '1.5' }}>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="body_text">
              ...
              <span className="question">Loblolly Software, LLC</span>
              <span className="statement-end-if-in-editor" /> does with any information we collect?
              Click&nbsp;
            </span>
          </span>
          <a data-custom-class="link" href="#toc">
          ...
          <div style={{ lineHeight: '1.5' }}>
            ...
            <ul>
              <li style={{ lineHeight: '1.5' }}>
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    <em>Mobile Device Data.</em> We automatically collect device information (such
                ...
                <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                  <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                    <span data-custom-class="body_text">
                      ...
                      technologies. <span className="block-component" />
                      <span className="block-component" />
                    </span>
                  </span>
                </span>
                  ...
                  <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                    <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                      <span data-custom-class="body_text">
                        ...
                        <span style={{ fontSize: 15 }}>&nbsp;</span>(such as the date/time stamps
